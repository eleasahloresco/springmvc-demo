...
<form:form id="myform" modelAttribute="employee" action="${action}" method="POST" class="standard-form">
	<div>
		<div class="left-panel" style="margin-right: 30px;">
			<div class="field">
				<form:label for="employeeId" path="employeeId" cssErrorClass="field-error">Employee ID:</form:label>
				<form:input path="employeeId" cssClass="textbox" cssErrorClass="textbox field-error" />
				<div class="clear-both"></div>
				<form:errors path="employeeId" cssClass="help field-error" />
			</div>
			<div class="field">
